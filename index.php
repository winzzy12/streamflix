...
<section class="container">
  ...
  <div style="text-align:center; margin-bottom:18px">
    ...
    <h2 style="margin-bottom:6px;">Selamat Datang di Streamflix</h2>

    <p style="opacity:.8; max-width:780px; margin:auto">
       Streamflix – Your Favorite Movies, Anytime.
       Nikmati streaming film dan serial pilihan dengan kualitas terbaik. Temukan hiburan tanpa batas, kapan saja dan di mana saja.
    </p>

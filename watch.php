...
// PRIORITAS: link > video lokal
if (!empty($video['link'])) {
  $videoPath = $video['link'];       // video via URL eksternal
} else {
  $videoPath = $video['video'];      // video tersimpan di server
}
...
<div class="center-area">
  ...
  <!-- VIDEO -->
<iframe
  src="player_secure.php?id=<?= $id ?>"
  width="100%"
  height="520"
  style="border:0;border-radius:12px;box-shadow:0 0 20px rgba(255,255,255,.1);"
  allowfullscreen
></iframe>
